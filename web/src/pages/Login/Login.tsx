...
export function Login({ setUserAccount }: ILogin) {
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center">
      <div className=" md:border md:border-gray-300 bg-white md:shadow-lg shadow-none rounded flex flex-col p-10 gap-8">
        ...
        <form onSubmit={handleSubmit}>
          <div className="relative mb-2">
            <input
              id="email"
              className="w-full flex items-center rounded px-3 border border-gray-300 pt-3 pb-3 focus:border-blue-700 focus:ring-1 focus:ring-blue-700 focus:outline-none input active:outline-none"
              type="email"
          ...
          <div className="space-y-9">
            ...
            <div className="text-sm flex justify-between items-center">
              <a
                className="font-bold text-blue-500 py-2 px-2 rounded -ml-2 hover:bg-blue-50 hover:text-blue-700"
                href="#"
              >
                Create account
              </a>
              <button className="py-2 px-6 rounded text-white btn bg-blue-500 hover:bg-blue-600">
                Next
              </button>
            </div>
          </div>
