export default function AccountOptions() {
  return (
    <div className="flex-1 flex items-center justify-end gap-4">
      <div className="border border-gray-300 pl-4 pr-2 py-2 rounded-full flex items-center space-x-2">
      ...
      <a
        ...
        target="_blank"
        className="border border-gray-200 p-2 flex space-x-2 items-center rounded-md cursor-pointer hover:bg-gray-100"
        rel="noreferrer"
      >
        <img
